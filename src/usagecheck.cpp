...
void print_EKF_data(const VectorXd &RMSE, const vector<VectorXd> &estimations,
  ...
  for (int k = 0; k < all_sensor_data.size(); ++k){
    ...
    if (all_sensor_data[k].get_type() == DataPointType::LIDAR){
      ...
      cout << setw(10) << left << lidar_v(0) << " | ";
      cout << setw(10) << left << lidar_v(1) << " | " << endl;
    ...
    cout << setw(10) << left << estimations[k](0) << " | ";
    cout << setw(10) << left << estimations[k](1) << " | ";
    cout << setw(10) << left << estimations[k](2) << " | ";
    cout << setw(10) << left << estimations[k](3) << " | " << endl;

    cout << setw(15) << left << "TRUTH:" << " | ";
    cout << setw(10) << left << ground_truths[k](0) << " | ";
    cout << setw(10) << left << ground_truths[k](1) << " | ";
    cout << setw(10) << left << ground_truths[k](2) << " | ";
    cout << setw(10) << left << ground_truths[k](3) << " | " << endl;
  }
}
